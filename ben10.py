...
# Inicializar
pygame.init()
pygame.mixer.music.load("ben10int.ogg")
...
while en_juego:
    ...
    while en_inicio:
        ...
        historia = [
            ...
            "                 El omnnitrix se descontroló.",
            "               Vilgax secuestró a Gwen y al abuelo, ",
            "              tus aliens y enemigos te intentan acabar",
            "               habra que llegar con Gwen y el abuelo",
            "         para poder derrotar a vilgax y a los que te atacan",
            "              Intenta evadirlos para poder rescatarlos.",
            "",
    ...
    while en_partida:
        ...
        while en_final:
            ...
            historia_perdido = [
                "    No pudiste salvar a Gwen y al abuelos. Vilgax y",
                "   tus enemigos te han tratado de arrebatar el omnitrix.",
                "   Sin embargo los plomeros te salvaron por nada. ",
                "  ¿Quieres recuperar fuerza y volver a intentarlo?",
                "",
                "              Pulsa 's' para volverlo a intentar",
                "              Pulsa 'n' para salir del juego"]

            historia_ganado = [
                "  Excelente, acabas de salvar a Gwen y al abuelo, y derrotaste a",
                "  los malos. Los plomeros estarán muy contentos con este gran triunfo.",
                "       Te has convertido en el salvador del universo. De nuevo",
                "       ¿Quieres hacer otra misión?",
                "",
